...
const verifier = (0, _verifier.default)(_config.default);
...
const verifyParams = params => verifier.verify(params, { resolveImports: resolver(params.imports) });exports.verifyParams = verifyParams;var _default =
